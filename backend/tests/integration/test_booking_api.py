...
@pytest.mark.asyncio
async def test_create_booking_unauthorized(client):
    payload = {
...
@pytest.mark.asyncio
async def test_create_booking_success(client, async_session):
...
@pytest.mark.asyncio
async def test_list_bookings_only_user_records(client, async_session):
...
@pytest.mark.asyncio
async def test_update_booking_status_success(client, async_session):
...
@pytest.mark.asyncio
async def test_update_booking_status_not_found(client, async_session):
    # Create a user and authenticate
...
@pytest.mark.asyncio
async def test_delete_booking_not_found(client, async_session):
    # Create a user and authenticate
...
@pytest.mark.asyncio
async def test_delete_booking_success(client, async_session):
